import { I3DXMatrix, I3DXVector, I3DXMatrixIdentity, I3DXVectorUnit, I3DXMatrixSubtract, I3DXVectorCross, I3DXVectorDot, } from './matrix';
...
export function I3DXMatrixLookAtLH(pEye, pAt, pUp) {
...
export function I3DXMatrixPerspectiveFovLH(fovy, aspect, zn, zf) {
...
export function I3DXBarycentricCoords(x, y, x1, y1, x2, y2, x3, y3) {
    const y2y3 = y2 - y3;
    const x3x2 = x3 - x2;
    const x1x3 = x1 - x3;
    const y1y3 = y1 - y3;
